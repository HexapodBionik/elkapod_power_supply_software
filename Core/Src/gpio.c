...
void MX_GPIO_Init(void)
{
  ...
  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin(GPIOC, TASK_CHECK_1_Pin|TASK_CHECK_2_Pin, GPIO_PIN_RESET);
  ...
  /*Configure GPIO pins : FLASH_RESET_Pin FLASH_CS_Pin */
  ...
  /*Configure GPIO pins : TASK_CHECK_1_Pin TASK_CHECK_2_Pin */
  GPIO_InitStruct.Pin = TASK_CHECK_1_Pin|TASK_CHECK_2_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
