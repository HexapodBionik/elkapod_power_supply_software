...
void MX_GPIO_Init(void)
{
  ...
  /*Configure GPIO pins : SW_FUNC_Pin SW_CLR_ERR_Pin */
  GPIO_InitStruct.Pin = SW_FUNC_Pin|SW_CLR_ERR_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_INPUT;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  HAL_GPIO_Init(GPIOG, &GPIO_InitStruct);

  /*Configure GPIO pin : SW_BAT_INDICATOR_Pin */
  GPIO_InitStruct.Pin = SW_BAT_INDICATOR_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_IT_FALLING;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  HAL_GPIO_Init(SW_BAT_INDICATOR_GPIO_Port, &GPIO_InitStruct);
