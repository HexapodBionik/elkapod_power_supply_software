...
#define I_STANDBY_SENSE_Pin GPIO_PIN_4
#define I_STANDBY_SENSE_GPIO_Port GPIOF
#define I_3V3_POW_SENSE_Pin GPIO_PIN_5
#define I_3V3_POW_SENSE_GPIO_Port GPIOF
#define I_5V_POW_SENSE_Pin GPIO_PIN_6
#define I_5V_POW_SENSE_GPIO_Port GPIOF
#define I_MANIP_SENSE_Pin GPIO_PIN_8
#define I_MANIP_SENSE_GPIO_Port GPIOF
#define I_SERVO18_Pin GPIO_PIN_9
#define I_SERVO18_GPIO_Port GPIOF
#define I_SERVO17_Pin GPIO_PIN_10
#define I_SERVO17_GPIO_Port GPIOF
#define I_SERVO16_Pin GPIO_PIN_0
#define I_SERVO16_GPIO_Port GPIOC
#define I_SERVO15_Pin GPIO_PIN_1
#define I_SERVO15_GPIO_Port GPIOC
#define I_SERVO14_Pin GPIO_PIN_2
#define I_SERVO14_GPIO_Port GPIOC
#define I_SERVO13_Pin GPIO_PIN_3
#define I_SERVO13_GPIO_Port GPIOC
#define I_SERVO12_Pin GPIO_PIN_0
#define I_SERVO12_GPIO_Port GPIOA
#define I_SERVO11_Pin GPIO_PIN_1
#define I_SERVO11_GPIO_Port GPIOA
#define I_SERVO10_Pin GPIO_PIN_2
#define I_SERVO10_GPIO_Port GPIOA
#define I_SERVO9_Pin GPIO_PIN_3
#define I_SERVO9_GPIO_Port GPIOA
#define I_SERVO8_Pin GPIO_PIN_4
#define I_SERVO8_GPIO_Port GPIOA
#define I_SERVO7_Pin GPIO_PIN_5
#define I_SERVO7_GPIO_Port GPIOA
#define I_SERVO6_Pin GPIO_PIN_6
#define I_SERVO6_GPIO_Port GPIOA
#define I_SERVO5_Pin GPIO_PIN_7
#define I_SERVO5_GPIO_Port GPIOA
#define I_SERVO4_Pin GPIO_PIN_4
#define I_SERVO4_GPIO_Port GPIOC
#define I_SERVO3_Pin GPIO_PIN_5
#define I_SERVO3_GPIO_Port GPIOC
#define I_SERVO2_Pin GPIO_PIN_0
#define I_SERVO2_GPIO_Port GPIOB
#define I_SERVO1_Pin GPIO_PIN_1
#define I_SERVO1_GPIO_Port GPIOB
...
#define LED_CONV5_Pin GPIO_PIN_11
#define LED_CONV5_GPIO_Port GPIOB
#define LED_CONV4_Pin GPIO_PIN_13
#define LED_CONV4_GPIO_Port GPIOB
#define LED_CONV3_Pin GPIO_PIN_14
#define LED_CONV3_GPIO_Port GPIOB
#define LED_CONV2_Pin GPIO_PIN_15
#define LED_CONV2_GPIO_Port GPIOB
#define LED_CONV1_Pin GPIO_PIN_8
#define LED_CONV1_GPIO_Port GPIOD
...
#define LED_POWER_ON_Pin GPIO_PIN_13
#define LED_POWER_ON_GPIO_Port GPIOD
#define LED_FATAL_ERROR_Pin GPIO_PIN_14
#define LED_FATAL_ERROR_GPIO_Port GPIOD
#define SW_FUNC_Pin GPIO_PIN_15
#define SW_FUNC_GPIO_Port GPIOD
#define SW_CLR_ERR_Pin GPIO_PIN_2
#define SW_CLR_ERR_GPIO_Port GPIOG
#define BAT_INDICATOR1_Pin GPIO_PIN_3
#define BAT_INDICATOR1_GPIO_Port GPIOG
#define BAT_INDICATOR2_Pin GPIO_PIN_4
#define BAT_INDICATOR2_GPIO_Port GPIOG
#define BAT_INDICATOR3_Pin GPIO_PIN_5
#define BAT_INDICATOR3_GPIO_Port GPIOG
#define BAT_INDICATOR4_Pin GPIO_PIN_6
#define BAT_INDICATOR4_GPIO_Port GPIOG
#define BAT_INDICATOR5_Pin GPIO_PIN_7
...
#define CS_CONV_ADC_Pin GPIO_PIN_0
#define CS_CONV_ADC_GPIO_Port GPIOD
#define V_OUT_EN6_Pin GPIO_PIN_11
#define V_OUT_EN6_GPIO_Port GPIOG
#define V_OUT_EN5_Pin GPIO_PIN_12
#define V_OUT_EN5_GPIO_Port GPIOG
#define V_OUT_EN4_Pin GPIO_PIN_15
#define V_OUT_EN4_GPIO_Port GPIOG
#define V_OUT_EN3_Pin GPIO_PIN_6
#define V_OUT_EN3_GPIO_Port GPIOB
#define V_OUT_EN2_Pin GPIO_PIN_7
